...
\subsection{高斯分布}
	...
	\begin{figure}[b]
		...
		\parbox{.5\textwidth}{\includegraphics[width=8cm]{Figure1-13.png}}
	\end{figure}
	...
	\begin{figure}[t]
		...
		\parbox{.5\textwidth}{\includegraphics[width=8cm]{Figure1-14.png}}
	\end{figure}
	...
	\begin{figure}[t]
		...
		\parbox{.5\textwidth}{\includegraphics[width=8cm]{Figure1-15.png}}
	\end{figure}
...
\subsection{曲线拟合}
	...
	\begin{figure}[t]
		...
		\parbox{.5\textwidth}{\includegraphics[width=8cm]{Figure1-16.png}}
	\end{figure}
...
\subsection{贝叶斯曲线拟合}
	...
	\begin{figure}[t]
		...
		\parbox{.5\textwidth}{\includegraphics[width=8cm]{Figure1-17.eps}}
	\end{figure}
...
\section{维灾难}
	...
	\begin{figure}[t]
		...
		\parbox{.5\textwidth}{\includegraphics[width=8cm]{Figure1-19.eps}}
	\end{figure}
	...
	\begin{figure}[t]
		...
		\parbox{.5\textwidth}{\includegraphics[width=8cm]{Figure1-21.png}}
	\end{figure}
	...
	\begin{figure}[t]
		...
		\parbox{.5\textwidth}{\includegraphics[width=8cm]{Figure1-22.eps}}
	\end{figure}
	
	作为直接和模式识别相关的另一个实例，考虑在高维空间中的高斯分布行为。如果我们将笛卡尔坐标转换为极坐标，然后对方向变量进行积分，就可以得到关于半径\textit{r}的密度表达式$p(r)$。因此$p(r)\delta r$是半径为r的薄片$\delta r$的概率密度。对于不同的D值，分布在图1.23中显示，我们可以看到对于大的\textit{D}值，高斯分布的概率密度集中在一小片。
	
	\begin{figure}[t]
		\parbox{.4\textwidth}{\caption{ 图示为对于不同的维度D，关于半径的高低分布概率密度函数。在高维空间中，大多数的高斯概率密度位于特定半径的一小薄片内 }}
		\parbox{.5\textwidth}{\includegraphics[width=8cm]{Figure1-23.eps}}
	\end{figure}
