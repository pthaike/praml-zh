...
\renewcommand\section{\@startsection{section}{1}{\z@}%
	...
	{.5ex \@plus .1ex}%
	{\normalfont\foursize\color{blue}\CJKfamily{hei}}}
\makeatother
...
\renewcommand\subsection{\@startsection{subsection}{1}{\z@}%
	...
	{.4ex \@plus .1ex}%
	{\normalfont\mfoursize\color{blue}\CJKfamily{hei}}}
\makeatother
...
\title{模式识别和机器学习\footnote{Pattern Recognition And Machine Learning, Christopher M. Bishop }}
\author{庞廷海\footnote{ 译者：庞廷海：四川大学计算机学院，硕士，知识发现与数据工程
		Email : pthaike@gmail.com}\\[2ex]
